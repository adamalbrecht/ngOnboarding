      ...
      return {
        ...
        templateUrl: function() {
          if (ngOnboardingDefaults.customTemplate) {
            return ngOnboardingDefaults.customTemplate;
          } else {
